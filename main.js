...
nasa_mars_imges_array=["nasa_image_1.jpg,nasa_image_2.jpeg,nasa_image_3.jpg,nasa_image_4.jpg"]
random_number =Math.floor(Math.random()*4)
background_image =nasa_mars_imges_array[random_number];
...
function up(){
    ...
    if(rover_y>=0){
        rover_y=rover_y -10;
        console.log("when up arrow is pressed,y="+ rover_y +"|y = + rover_y");
        uploadBackground();
        uploadrover();
    }
}
...
function right(){
	if(rover_x<=700){
        rover_x=rover_x +10;
        console.log("when up arrow is pressed,x="+ rover_x +"|x = + rover_x");
        uploadBackground();
        uploadrover();
    }
}
